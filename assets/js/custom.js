(function($) {
    ...
    // Datetimepicker
    $('.checkin_date').datepicker({autoclose: true, todayHighlight: true,dateFormat: 'yy-mm-dd',minDate: 0});

    // Datetimepicker
    $('#datetimepicker-check').datepicker({autoclose: false, todayHighlight: false,dateFormat: 'yy-mm-dd',minDate: 0});
