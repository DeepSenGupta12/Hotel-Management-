...
if(isset($_GET['delid']))
{
    $delete = mysqli_query($mysqli,"delete from `room_category` where `id` = '".$_GET['delid']."'");
}
$devider = 50;
if(isset($_GET['page']))
{
                                    ...
                                    ?>
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex ">
                                            <div>
                                              <h6><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;<?php echo strtoupper($fetchData_Res['price']);?>/-</h6>
                                        ...
                                        <td>
                                          <div class="d-flex ">
                                            <div>
                                              <h6><?php echo strtoupper($fetchData_Res['no_room']);?></h6>
                                            
                                            </div>
                                          </div>
                                        </td>
                                        <td>
                                        <img src="<?php echo $sitelink;?>/assets/roomimages/<?php echo $fetchData_Res['images'];?>" alt="">
                                        </td>
                                        <td>
                                          <?php
