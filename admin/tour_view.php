...
if(isset($_GET['delid']))
{
    $delete = mysqli_query($mysqli,"delete from `tour_place` where `id` = '".$_GET['delid']."'");
}
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">TOUR PLACES</h4>
                                   <p class="card-subtitle card-subtitle-dash">List of tour places</p>
                                  </div>
