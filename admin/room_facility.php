...
$sql = "SELECT * FROM `room_facility` ";
$fetchData_rec = mysqli_query($mysqli, $sql . " order by `id` asc");
...
<body>
  <!-- <div id="modelPanel" class="modal fade" role="dialog">
    <div class="modal-dialog imagepreviewdialog">
        <div class="modal-content modelpanelcontent" style="border-radius: 0px !important;padding:0px;"></div>
    </div>
</div> -->
  <!-- Modal -->
  <div id="modelPanel" class="modal fade" role="dialog">
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">ROOM FACILITY</h4>
                                    <p class="card-subtitle card-subtitle-dash">List of facilities</p>
                                  </div>
                                  <div>
                                    <a data-toggle="modal" data-target="#modelPanel"
                                      href="<?php echo $link; ?>/widgets/addFacility"
                                      class="btn btn-primary btn-lg text-white mb-0 me-0"><i class="fa fa-plus"></i>ADD
                                      FACILITY</a>
                                  </div>
                                </div>
                                            ...
                                            <div class="d-flex ">
                                              <div>
                                                <img style="width: 150px;height: auto;"
                                                  src="<?php echo $sitelink . "/assets/services/" . $fetchData_Res['images']; ?>"
                                                  alt="">
                                            ...
                                            <div>
                                              <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2" style="">
                                                  <a class="dropdown-item" data-toggle="modal" data-target="#modelPanel"
                                                    href="<?php echo $link; ?>/widgets/addFacility/<?php echo $fetchData_Res['id']; ?>">Edit</a>
                                                  <a class="dropdown-item"
                                                    onClick="deleteData('<?php echo $_SERVER['PHP_SELF']; ?>?delid=<?php echo $fetchData_Res['id']; ?>')">Delete</a>
