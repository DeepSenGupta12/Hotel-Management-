...
$fetchData_rec = mysqli_query($mysqli,"select * from `room_images` where `room_id`='".$roomDetails['id']."' order by `id` desc");
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">NEWS IMAGES <span style="color:green">[<?php echo strtoupper($roomDetails['title']);?>]</span></h4>
                                   <p class="card-subtitle card-subtitle-dash">List of images</p>
                                  </div>
                                  <div>
                                    <a href="<?php echo $link;?>/room_add_images/<?php echo $roomDetails['id'];?>" class="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i class="fa fa-plus"></i>ADD IMAGES</a>
                                  </div>
                                </div>
                                  ...
                                  <table class="table select-table">
                                    ...
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2" style="">
                                        ...
                                        <a class="dropdown-item" onClick="deleteData('<?php echo $_SERVER['PHP_SELF'];?>?delid=<?php echo $fetchData_Res['id'];?>&roomid=<?php echo $roomDetails['id'];?>')">Delete</a>
